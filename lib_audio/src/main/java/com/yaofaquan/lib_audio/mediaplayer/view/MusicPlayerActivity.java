...
import com.yaofaquan.lib_audio.mediaplayer.utils.Utils;
...
//                dialog.show();
    ...
    public void onAudioFavouriteEvent(AudioFavouriteEvent event) {
        Log.d(TAG, "onAudioFavouriteEvent");
        //更新activity收藏状态
    ...
    public void onAudioPlayModeEvent(AudioPlayModeEvent event) {
        Log.d(TAG, "onAudioPlayModeEvent");
